...
from dcgan.DCGANtensorflow.model import DCGAN
from dcgan.DCGANtensorflow.utils import pp, visualize, to_json, show_all_variables, expand_path, timestamp

import tensorflow as tf
#These flags are only used in the original DCGan implementation, we already defined these in reconstruction_methods
'''flags = tf.app.flags 
...
flags.DEFINE_integer("sample_freq", 1, "sample every this many iterations") #200
flags.DEFINE_integer("ckpt_freq", 5, "save checkpoint every this many iterations") #200
